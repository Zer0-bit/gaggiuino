...
void lcdUploadCfg(eepromValues_t& eepromCurrentValues) {
  ...
  myNex.writeNum("moreTemp.n1.val",
                 eepromCurrentValues.setpoint - eepromCurrentValues.offsetTemp);

  myNex.writeNum("steamSetPoint", eepromCurrentValues.steamSetPoint);
  myNex.writeNum("moreTemp.n6.val", eepromCurrentValues.steamSetPoint -
                                        eepromCurrentValues.offsetTemp);
  ...
  myNex.writeNum("brewAuto.pStartBar.val",
                 eepromCurrentValues.pressureProfilingStart * 10.f);

  myNex.writeNum("ppFlowStart", eepromCurrentValues.flowProfileStart * 10.f);
  myNex.writeNum("brewAuto.flowStartBox.val",
                 eepromCurrentValues.flowProfileStart * 10.f);

  myNex.writeNum("ppFin", eepromCurrentValues.pressureProfilingFinish * 10.f);
  myNex.writeNum("brewAuto.pEndBar.val",
                 eepromCurrentValues.pressureProfilingFinish * 10.f);

  myNex.writeNum("ppFlowFinish", eepromCurrentValues.flowProfileEnd * 10.f);
  myNex.writeNum("brewAuto.flowEndBox.val",
                 eepromCurrentValues.flowProfileEnd * 10.f);
  ...
  myNex.writeNum("ppFlowPressure",
                 eepromCurrentValues.flowProfilePressureTarget * 10.f);
  myNex.writeNum("brewAuto.flowBarBox.val",
                 eepromCurrentValues.flowProfilePressureTarget * 10.f);

  myNex.writeNum("ppLength", eepromCurrentValues.pressureProfilingLength);
  myNex.writeNum("brewAuto.n6.val",
                 eepromCurrentValues.pressureProfilingLength);

  myNex.writeNum("ppFlowCurveSpeed", eepromCurrentValues.flowProfileCurveSpeed);
  myNex.writeNum("brewAuto.flowRampBox.val",
  ...
  myNex.writeNum("brewAuto.bt1.val",
  ...
  myNex.writeNum("brewAuto.flowPIbox.val",
                 eepromCurrentValues.preinfusionFlowVol * 10.f);

  myNex.writeNum("piBar", eepromCurrentValues.preinfusionBar * 10.f);
  myNex.writeNum("brewAuto.piTargetBar.val",
                 eepromCurrentValues.preinfusionBar * 10.f);

  myNex.writeNum("piFlowTime", eepromCurrentValues.preinfusionFlowTime);
  myNex.writeNum("brewAuto.flowPiSecBox.val",
                 eepromCurrentValues.preinfusionFlowTime);
  ...
  myNex.writeNum("brewAuto.flowPiSoakBox.val",
                 eepromCurrentValues.preinfusionFlowSoakTime);

  myNex.writeNum("piFlowPressure",
                 eepromCurrentValues.preinfusionFlowPressureTarget * 10.f);
  myNex.writeNum("brewAuto.flowPiBarBox.val",
                 eepromCurrentValues.preinfusionFlowPressureTarget * 10.f);
  ...
  myNex.writeNum("morePower.pump_zero.val",
                 eepromCurrentValues.pumpFlowAtZero * 10000.f);

  myNex.writeNum("homeOnBrewFinish", eepromCurrentValues.homeOnShotFinish);
  myNex.writeNum("brewSettings.btGoHome.val",
                 eepromCurrentValues.homeOnShotFinish);

  myNex.writeNum("basketPrefill", eepromCurrentValues.basketPrefill);
  myNex.writeNum("brewSettings.btPrefill.val",
                 eepromCurrentValues.basketPrefill);
  ...
  myNex.writeNum("brewSettings.btTempDelta.val",
                 eepromCurrentValues.brewDeltaState);

  myNex.writeNum("switchPhaseOnThreshold",
                 eepromCurrentValues.switchPhaseOnThreshold);
  myNex.writeNum("brewSettings.btPhaseSwitch.val",
                 eepromCurrentValues.switchPhaseOnThreshold);
  ...
  myNex.writeNum("shotCustomVal",
                 eepromCurrentValues.shotStopOnCustomWeight * 10.f);
}
...
eepromValues_t lcdDownloadCfg(void) {
  ...
  lcdCfg.preinfusionFlowPressureTarget =
      myNex.readNumber("piFlowPressure") / 10.f;
