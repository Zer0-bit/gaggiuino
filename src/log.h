...
#define LOG_ERROR(msg, ...)                               \
    do {                                                  \
        log("E", FILENAME, __LINE__, msg, ##__VA_ARGS__); \
    } while (0)
#else
#define LOG_ERROR(msg, ...)
#endif
...
#define LOG_INFO(msg, ...)                                \
    do {                                                  \
        log("I", FILENAME, __LINE__, msg, ##__VA_ARGS__); \
    } while (0)
#else
#define LOG_INFO(msg, ...)
#endif
...
#define LOG_VERBOSE(msg, ...)                             \
    do {                                                  \
        log("V", FILENAME, __LINE__, msg, ##__VA_ARGS__); \
    } while (0)
#else
#define LOG_VERBOSE(msg, ...)
#endif
...
#define LOG_DEBUG(msg, ...)                               \
    do {                                                  \
        log("D", FILENAME, __LINE__, msg, ##__VA_ARGS__); \
    } while (0)
#else
#define LOG_DEBUG(msg, ...)
#endif
