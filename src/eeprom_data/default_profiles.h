...
namespace {
  ...
  const profileDefaults_t defaultsProfile[MAX_PROFILES] = {
    ...
    {"Adaptive",/*pi*/true, true, 0, 0.f, 6.f, 10, 3.f, 0.f, 600, true, 0.f,/*sk*/true, 0, 5, 3.f, 0.f, 0.f, 0.f, 0.f, 1, 3,/*tp*/true, false, 3.f, 9.f, 1, 3.f, 15, 0, 3.f, 2.f, 2.f, 1, 7.f, 15, 0, 7.f,/*pf*/true, true, 0.f, 0.f, 15, 0, 3.f, 2.0f, 2.f, 15, 0, 0.f,/*other*/ 93, true, 18.f, 0.f, 2},  // profile 2
