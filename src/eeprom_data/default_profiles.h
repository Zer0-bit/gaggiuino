...
namespace {
  ...
  const profileDefaults_t defaultsProfile[MAX_PROFILES] = {
    ...
    {"Londinium",/*pi*/true, true, 10, 2.f, 3.f, 20, 4.f, 9.f, 650, true, 0.f,/*sk*/true, 15, 10, 0.f, 0.f, 0.7f, 0.f, 0.f, 5, 2,/*tp*/true, false, 9.f, 9.f, 1, 3.f, 0, 0, 3.f, 0.f, 0.f, 0, 0.f, 0, 0, 0.f,/*pf*/true, false, 9.f, 3.f, 20, 0, 3.f, 0.f, 0.f, 0, 0, 0.f,/*other*/ 92, true, 20.f, 0.f, 2},  // profile 1
    {"Adaptive",/*pi*/true, true, 0, 0.f, 0.f, 10, 3.f, 6.f, 600, true, 0.f,/*sk*/true, 0, 5, 3.f, 0.f, 0.f, 0.f, 0.f, 1, 3,/*tp*/true, false, 3.f, 9.f, 1, 3.f, 15, 0, 3.f, 2.f, 2.f, 1, 7.f, 15, 0, 7.f,/*pf*/true, true, 0.f, 0.f, 15, 0, 3.f, 2.5f, 1.f, 15, 0, 6.f,/*other*/ 93, true, 18.f, 0.f, 2},  // profile 2
    {"Filter 2.1",/*pi*/true, true, 10, 2.f, 3.f, 15, 1.f, 4.f, 600, true, 0.f,/*sk*/true, 7, 90, 0.f, 0.2f, 0.f, 0.f, 45.f, 0, 0,/*tp*/true, true, 9.f, 6.f, 1, 3.f, 15, 0, 3.f, 0.2f, 3.f, 0, 0.f, 8, 0, 0.f,/*pf*/true, true, 0.f, 0.f, 15, 0, 3.f, 2.5f, 1.f, 15, 0, 6.f,/*other*/ 93, true, 18.f, 0.f, 2},  // profile 3
    {"Blooming espresso",/*pi*/true, true, 10, 2.f, 3.f, 20, 7.f, 4.f, 650, true, 0.f,/*sk*/true, 7, 30, 0.f, 0.f, 0.6f, 0.f, 5.f, 5, 2,/*tp*/true, true, 9.f, 6.f, 1, 3.f, 15, 0, 2.f, 2.f, 2.f, 1, 9.f, 15, 4, 9.f,/*pf*/true, true, 0.f, 0.f, 15, 0, 3.f, 2.5f, 1.f, 15, 0, 6.f,/*other*/ 93, true, 18.f, 0.f, 2}  // profile 4
  };
}
