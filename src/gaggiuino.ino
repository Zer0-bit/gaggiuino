...
//     float pressure_bar = (voltage-voltageZero)*3.0; // converting to bars of pressure
//     return pressure_bar;*/
//   static unsigned long presTimer;
//   static float presLast = 0.;
//   static unsigned char presIndex = 0;
//   static unsigned int presData[2];
//   unsigned long now = millis();
//   if (now - presTimer >= 10)
//   {
//     presTimer = now;
//     presData[presIndex] = analogRead(pressurePin);
//     if (presIndex)
//     {
//       float voltage = ((presData[0] + presData[1]) * 2.5) / 1024.0; // finding the voltage representation of the current analog value
//       presLast = (voltage - voltageZero) * 3.0;                     // converting to bars of pressure
//       presIndex = 0;
//     }
//     else
//     {
